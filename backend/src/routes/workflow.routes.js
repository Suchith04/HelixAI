...
import { validate, workflowValidation, graphWorkflowValidation, mongoIdValidation } from '../middleware/validation.js';
...
workflowRoutes.post('/graph', requirePermission('execute_workflows'), graphWorkflowValidation, validate, workflowController.createWorkflow);
...
workflowRoutes.put('/graph/:id', requirePermission('execute_workflows'), graphWorkflowValidation, validate, workflowController.updateWorkflow);
